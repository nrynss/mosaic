...
| P33 | Separate the reusable internal core from the domestic-disturbance reference profile and UI composition boundary | P32 | See `docs/handoffs/P33-domain-profile-separation.md` | ⬜ Ready — builder handoff published |
