...
└─ parcel/P33-domain-profile-separation              (claimed)
```
...
| P33 | Separate the reusable internal core from the domestic-disturbance domain profile and UI composition | P32 | `HANDOFF.md`, `docs/demo-script.md`, `docs/rfcs/RFC-0004-internal-domain-profile-separation.md`, `internal/profile/**`, `internal/reference/domesticdisturbance/**`, `internal/dataset/**`, `internal/simulator/**`, `internal/state/**`, `internal/api/evidence.go`, `cmd/datasetgen/**`, `cmd/mosaicdemo/**`, `cmd/simulator/**`, `docs/runbook/**`, `Dockerfile`, `docker-compose.yml` | 🔒 Claimed — coordinator |
...
- 2026-07-20 P33 claimed by coordinator — base `12c0c95`, branch `parcel/P33-domain-profile-separation`, worktree `.worktrees/P33-domain-profile-separation`; user directed an internal domain/UI separation refactor, not a public SDK or plugin host.
