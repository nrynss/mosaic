...
| ID | Task | Size | Deps | Claim | Status |
|----|------|------|------|-------|--------|
| E1 | `docker-compose` = **two services** (stateless app + Postgres), the decided topology; app stays stateless. Single-container appliance is out of scope for v0.4 | **M** | B1 | Opus agent | Done (fae95de) |
